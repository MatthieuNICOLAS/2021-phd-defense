...
\usepackage[backend=biber,maxbibnames=1,maxcitenames=1]{biblatex}
...
\input{content/rls-state-of-art}
...
\subsection{Gestion des opérations \emph{insert} et \emph{remove} concurrentes}

\input{content/rls-handling-concurrent-ins-rmv-ops}

\subsection{Gestion des opérations \emph{rename} concurrentes}
