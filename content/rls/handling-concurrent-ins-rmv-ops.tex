...
\begin{frame}{Mécanisme de résolution de conflits}
    \begin{block}{Besoins}
        \begin{enumerate}
            ...
            \item
                Prendre en compte effet des opérations \ren lors de l'intégration des opérations concurrentes
        \end{enumerate}
    \end{block}
\end{frame}
...
\begin{frame}[fragile]{Exemple de \texttt{renameId}}
    ...
    \begin{block}{Exemple avec {$\coloridthree\id{i}{B1}{0}\id{m}{B2}{0}$}}
      \begin{itemize}
        ...
        \item<3-> Utiliser son index (1) pour calculer équivalent à époque $\epoch{A2}$ : $\coloridtwo\id{i}{A2}{1}$
        \item<4-> Préfixer {$\coloridthree\id{i}{B1}{0}\id{m}{B2}{0}$} par ce dernier : $\coloridfour\id{i}{A2}{1}\id{i}{B1}{0}\id{m}{B2}{0}$
      \end{itemize}
    \end{block}
  \end{frame}
