...
\begin{frame}{Identifiant LogootSplit}
    ...
    \begin{block}{Identifiant}
        ...
        \begin{tikzpicture}[overlay,remember picture,>=stealth,nodes={align=left,inner ysep=1pt},<-]
            ...
            % For "nodeSeq"
            \path<4-> (nodeSeq.south) ++ (0,-2em) node[anchor=north west,color=ucl1mdgreen] (legend-nodeseq){\textbf{numéro de séquence (1-99)}};
            \draw<4-> [color=ucl1mdgreen](nodeSeq.south) |- ([xshift=0.3ex,color=ucl1mdgreen] legend-nodeseq.south east);
        \end{tikzpicture}
    \end{block}
    \onslide<5->{
        ...
        \resizebox{\columnwidth}{!}{
          \begin{tikzpicture}
            ...
            \path
                ...
                +(0:5) node[point, label=-170:{$\trm{ins}(1, E)$}] (a-ins-e) {}
                +(0:10) node[point] (a-recv-ins-o) {}
                +(0:15) node (a-final) {};
            ...
            \path
                ...
                +(0:5) node[point, label=170:{$\trm{ins}(2, O)$}] (b-ins-o) {}
                +(0:10) node[point] (b-recv-ins-e) {}
                +(0:15) node (b-final) {};
